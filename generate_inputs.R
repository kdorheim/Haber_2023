# Okay so from the first paper it looks like we used the NARR-ED2 inputs. So that will 
# be out starting point for this work as well. 
...
ofiles <- unlist(lapply(years, function(yr){
  ...
  ofile <- file.path(WRITE_TO, paste0("SEM_input_", yr, ".csv"))
